  ...
  return (
   	<div >
			...
			<div className='home-about-link-main '>
				...
				<p className='grow link f3 home-about-link pointer' >
					<Link  to='/careers' className='black no-underline'>Careers</Link> 
				</p>
			</div>
			<div>
				<p className='mobile-display-font-size-header f2 ml4 '>Careers </p>
			</div>

			<div>
				
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 athelas'>
						Working at Intruous Construction isn’t just like any other construction job.
						We build potential in our people. We develop and nurture<br/>
						out team, empowering you to achieve your career aspirations.
						The entire XYZ Group is also at your fingertips.<br/><br/><br/>
						At Intruous Construction we work hard at finding the right people to join
						our successful team and ensure that everyone has the <br/>right balance of skills, 
						education and experience together with the right behaviours, attitudes and values.<br/><br/><br/>
						Once you join Intruous Construction, you will enjoy industry-leading staff benefits,
						a fun social club, dedicated training to ensure<br/> that your career keeps moving 
						in the right direction and our commitment to create a work environment supported
						by our<br/> down-to-earth core values: authenticity, excellence, leadership, 
						relentlessness, passion and fun.<br/><br/><br/>
						Take a look at our current commercial construction opportunities below… <br/><br/>

					<h3 className='mobile-display-font-size-sub-header f3 gray '>OUR COMMERCIAL CONSTRUCTION JOBS </h3>	 
						<p className='mobile-display-font-size-paragraph f4  '>Everything from project managers, site managers, supervisors, HSEQ, contract
						administrators and estimators, through to<br/> document controllers, administrators
						and accounts staff. (Of course, if the role you’re after isn’t listed here, 
						please contact us<br/> anyway. We may have something in the pipeline, or we may 
						even create a role just for you.<br/><br/><br/>
						Choose your direction for the future. Apply for a commercial construction role
						with Intruous Construction now via our job board<br/> on the XYZ Group website<br/><br/><br/>
						</p>
