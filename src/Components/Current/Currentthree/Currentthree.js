...
function Currentthree() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Current project three'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing ' >
					<Link to='/currentthree' className='black no-underline'>KolKhoz  University</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Ataturk Street, Ashgabat - Turkmenistan </time>
				    ...
				    <time className="f3   gray ml4   ">Lachin Arhitektorlar </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <ul className='ph2 '>
				    	<li className='gray '>The university’s environmental footprint is minimised through the use of three
				    	 and four level buildings that are universally accessible and incorporate passive solar design 
				    	 principles.</li>
