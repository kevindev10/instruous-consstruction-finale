...
function Currentfour() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Current project four'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing ' >
					<Link to='/currentfour' className='black no-underline'>Koshido Industries</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Shirakwa Road, Nagoya - Japan </time>
				    ...
				    <time className="f3   gray ml4   ">Kimono Associates </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
