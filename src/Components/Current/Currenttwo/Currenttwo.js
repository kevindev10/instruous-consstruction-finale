  ...
  return (
   	<div >
			<div>
				...
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Current project two'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing'>
					<Link to='/current' className='black no-underline'>Current</Link>
				</p>
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing ' >
					<Link to='/currenttwo' className='black no-underline'>Alderen Pleje</Link>
				 </p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    <h1 className="f2 lh-title fw9 mb5 mt0  ">
				      Alderen Pleje Retirement Home
				    </h1>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Location
				    </h2>
				    <time className="f3   gray ml4   ">Assensvej Road, Middlefart - Denmark </time>
				    ...
				    <time className="f3   gray ml4   ">Hus-Larsen Arkitekter </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <ul className='ph2 '>
				    	<li className='gray '>The building is surrounded by a landscaped area framed by a sloping, 
				    	reinforced, curved, in-situ concrete wall. This wall is faced with natural cut limestone 
				    	blockwork and decorated with custom artwork fencing. This wall runs along the north elevation
				    	of the building. The feature fence was commissioned as part of the required artwork component 
				    	of the project. </li>
