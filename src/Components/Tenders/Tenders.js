  ...
  return (
   	<div >
			...
			<div className='home-about-link-main '>
				...
				<p className='grow link f3 home-about-link pointer' >
					<Link  to='tenders' className='black no-underline'>Tenders</Link> 
				</p>
			</div>
			<div>
				<p className='f2 ml4 mt0 mb3 fw6 '>Tenders </p>
			</div>

			<div>
				
				<p className='f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4'>
						To view the projects Instuous is currently tendering on, or to submit a price,
						 please visit <a href="https://www.tendersure.co.ke/" target="_blank"  rel="noreferrer" >Tendersure</a>.<br/><br/><br/>

						To contact our Estimating Department please direct your emails to :<br/><br/>
						  <p className=' link dim email w-20 f3 display-while-on-mobile'>tenders@instrousconstruction.com</p><br/><br/><br/>
