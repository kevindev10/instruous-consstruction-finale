...
function Completedfive() {
  return (
   <div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project five'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing '>
					<Link to='/completedfive' className='black no-underline'>Fairview Apartments</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				<h2 className="f3 gray  mb4 center fw7 ml4 ">
				      APARTMENTS & MIXED USE CONSTRUCTION
				</h2>
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Keunjang-ro-12-gil road, Daegu - South Korea</time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$36 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Kim Lee & Sons Architects </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled residential development include:
				    <ul className='ph2 '>
				    	<li className='gray '>Fairview Apartments delivers a show stopping timber void artwork as a feature wall 
				    	that extends to the roof through 5 floors that is met with an integrated timber deck on the third floor.</li>
