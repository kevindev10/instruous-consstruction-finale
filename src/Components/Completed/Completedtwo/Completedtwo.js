...
function Completedtwo() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project two'/>
			</div>
			...
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    <h1 className="f2 lh-title fw9 mb5 mt0  ">
				      Green Arces Retirement Village
				    </h1>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Location
				    </h2>
				    <time className="f3   gray ml4   ">Lesnya Road,Babayevo-Vologda </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$19 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   ">Bureau Bilayakov & Brothers</time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled Aged Care development include:
				    <ul className='ph2 '>
				    	<li className='gray '>IELVS (Integrated Extra-Low Voltage Services) Building Management System:
				    	 Which provides a platform that enables data from various service systems to be collected, consolidated
				    	  and made available for any enterprise application. 
				    	</li>
						<li className='gray '>Timber Trusses: We were responsible for the design and construction of the 
						timber trusses under the head contract. Coordination with the services consultants was necessary
						 to ensure there were no clashes with lighting, mechanical ductwork, hydraulics and fire pipework
						  and smoke compartments.</li>
				    </ul>
