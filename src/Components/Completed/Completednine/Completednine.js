...
function Completednine() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project nine'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing ' >
					<Link to='/completednine' className='black no-underline'>Golden Silk Resort</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Fattur Ngotok, East Java - Indonesia </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$89 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Brinkke Hadikai Architects </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				      The Golden Silk Resort in Fattur Ngotok, developed by Brinkke Hadikai Architects is a hospitality development consisting of 500 
				      rooms  over six levels located in a hidden gem overlooking the river in East Java. Nestled into a picturesque corner of Indonesia,
				       The Golden Silk Resort has been designed to engage with the natural surroundings while providing an environmentally responsible development 
				       	The resort was designed with well-sized rooms , large windows to take advantage of views and huge balconies, some with movable screens for
				       	 privacy.
				    </p>
				    <p className='f3 fw9 '>HIGHLIGHTS</p>
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled hospitaility development include:
				    <ul className='ph2 '>
				    	<li className='gray '>The Golden Silk Resort is an environmentally responsible development, featuring cross 
				    	ventilation to 78% of rooms, Low E double glazing, gas boosted solar hot water, roof-mounted 
				    	solar photovoltaic cells, solar pool heating and sustainably sourced timber. Natural light, ventilation and views to surroundings create 
				    	a pleasant arrival experience and all rooms have narrow depth providing good access to  natural light.
				      </li>
