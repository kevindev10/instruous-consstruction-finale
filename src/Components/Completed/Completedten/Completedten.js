...
function Completedten() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project ten'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing '>
					<Link to='/completedten' className='black no-underline'>Ridge Hills Industrial Park</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    <h1 className="f2 lh-title fw9 mb5 mt0  ">
				      Ridge Hills Industrial Park
				    </h1>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Location
				    </h2>
				    <time className="f3   gray ml4   ">Primeira Avenida Road,Brasilia - Brazil </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$99 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Sanoli Grupo do Arquitetos </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <ul className='ph2 '>
				    	<li className='gray '>We successfully delivered in a quick program (approx. 10-11 months).</li>
						<li className='gray '>Efficiency initiatives include a grey water recycling system and LED lighting.</li>
				    </ul>
