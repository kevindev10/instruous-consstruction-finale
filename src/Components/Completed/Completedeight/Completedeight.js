...
function Completedeight() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project eight'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing '>
					<Link to='/completedeight' className='black no-underline'>Pittsfield Community Center</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Kirchbuntstrasse road ,Vaduz-Liechtenstein </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$12 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Walser & Lantos Architects </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				      The Pittsfield Community Center is the first as-built rated 6 Star Green Star public building in Liechtenstein.
				      This mixed-use facility has become the cornerstone of the ambitious 24-hectare Pittsfield Park
				      redevelopment being undertaken by the City of Vaduz. The redevelopment has seen the community
				      facility integrated within new grounds including community piazza areas, skate park and nature 
				      play areas as well as redeveloped sporting facilities.
				    </p>
				    <p className='f3 fw9 '>HIGHLIGHTS</p>
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled community development include:
				    <ul className='ph2 '>
				    	<li className='gray '>Highly polished custom exposed aggregate precast concrete panels were polished to
				    	 such a degree that paint cannot stick to them, making them very low maintenance and harder to graffiti.
				    	  The panels were so specialised that only one supplier in Vaduz could achieve the design
				    	   required finish. The panels were polished using the only large automated flatbed polishing machine 
				    	   in the Capital</li>
