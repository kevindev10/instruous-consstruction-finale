...
function Completedseven() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project seven'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing '>
					<Link to='/completedseven' className='black no-underline'>Three Column Cafe</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Jan Jonker Street, Windhoek - Namibia </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$17 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Bosch & Tjitjo Associates </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled hospitality development include:
				    <ul className='ph2 '>
				    	<li className='gray '> The ceilings and grid, partitions, carpet, and then workstations were constructed to
				    	 mirror the feature architectural curved wing of the structure. This required extensive coordination and set out.</li>
