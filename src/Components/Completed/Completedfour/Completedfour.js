...
function Completedfour() {
  return (
   	<div >
			<div>
				<div className ='spacer '></div>
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project four'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing '>
					<Link to='/completedfour' className='black no-underline'>Botex Industries</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <time className="f3   gray ml4   ">Bacanora, Sonora, Mexico </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$39 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Philipe Arquitectos </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				      ...
				      Three times larger than Botex Mexico former property.
                      We were awarded the project following a competitive tender process.
				    </p>
				    <p className='f3 fw9 '>HIGHLIGHTS</p>
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled industrial development include:
				    <ul className='ph2 '>
				    	<li className='gray '>A supplier of cosmetic products, Botex Mexico's 
				    	 required a ‘superflat warehouse floor’ – the most stringent specification with a maximum deviation 
				    	 of plus or minus 3mm with a total area of 14,397m2. We successfully constructed the unique floor
				    	 utilising laser screeding technology and, in partnership with subcontractor Amigos Concrete, received
				    	 a world record for the flattest floor in its category.
				    	</li>
