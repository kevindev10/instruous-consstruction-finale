  ...
  return (
   	<div >
			<div>
				...
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project three'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='f3 home-about-link when-on-mobile-routing'>/</p>
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing ' >
					<Link to='/completedthree' className='black no-underline'>Inventure University</Link>
				</p>
			</div>
			<div className ='when-on-mobile' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    <h1 className="f2 lh-title fw9 mb5 mt0  ">
				      Inventure University
				    </h1>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Location
				    </h2>
				    <time className="f3   gray ml4   ">Vancouver City Center,Canada </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4 ">
				      Value
				    </h2>
				    <time className="f3   gray ml4  ">$29 million </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ml4">
				      Architect
				    </h2>
				    <time className="f3   gray ml4   "> Patay & Lemax Architects </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4 ml4 mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns">
				    ...
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				      Inventure University School of Engineering accommodates structural, civil and geotechnical facilities 
				      (including an overhead gantry crane) and a chemical engineering facility with two fume cupboards.
					  Instruous won the project via a competitive tender process.
				    </p>
				    <p className='f3 fw9 '>HIGHLIGHTS</p>
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding mh4">
				    Highlights of this feature-filled educational development include:
				    <ul className='ph2 '>
				    	<li className='gray '>The development features maritime,
				    		 environmental, materials and petroleum engineering labs with specialist equipment.
				    	</li>
						<li className='gray '>The sun shades on the windows are the building’s greatest architectural feature.</li>
				    </ul>
