...
import CompletedProjectsCover from './CompletedProjectsCover/CompletedProjectsCover'
import CompletedProjectsCards from './CompletedProjectsCards/CompletedProjectsCards'
		...
		return(
			...
			<div className='projects-mobile '>
				...
				<div className='home-about-link-main'>
					...
					<p className='grow link f3 home-about-link pointer' >
						<Link to='/completed' className='black no-underline' >COMPLETED PROJECTS</Link>
					</p>
				</div>
				<div>
					<p className='f2 tc mt0 mb3  athelas'>COMPLETED PROJECTS</p>
				</div>
				<div className=' ml0 mr0'>
					<p className=' center athelas mobile-display-font-size-sub-header f3 gray ph3  '>
						We have a solid reputation for undertaking educational, healthcare,	 
						community facilities, industrial, retail and refurbishment projects for both public 
					    and private sector clients.
					    We can operate under traditional contract, on a 'Design 
					    and Build' basis or as works packages on major schemes and under local and central government 
					    framework contracts.
					    Working within the education sector requires a specialist and sensitive 
					    approach to the bespoke nature of every individual project. Instruous Construction meticulously 
					    plan and 
					    strictly control the highest standards of health and safety on these sites which can
					    range from primary schools to special needs schools and young offenders institutions.
					</p>
				</div>
