  ...
  return (
   	<div>
			...
			<div className='home-about-link-main'>
				...
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer' >
					<Link to='/ourpeople' className='no-underline black'>Our People</Link>
				</p>
			</div>
			<div>
				<p className='f1 ml4 mt0 mb3 fw6'>OUR PEOPLE</p>
				<p className=' ml4 mt0 mb3 fw6 mobile-display-font-size-sub-header f3 gray'>Powered by people</p>
				<p className='f4 ml4 mt0 mb3  athelas mobile-display-font-size-paragraph'>
			...
			<div className ='ml4'>
				<section className="mw9 ">
				  ...
				  <article className="pv4 bt bb b--black-10 ph3 ph0-l">
				    <div className="flex flex-column flex-row-ns">
				      <div className="w-100 w-80-ns pr3-ns order-2 order-1-ns ">
				        <h1 className="f2 fw5  mt0 lh-title mobile-display-font-size-header">XAVIER HART</h1>
				        <h1 className="f3  mt0 lh-title mobile-display-font-size-sub-header gray">GENERAL MANAGER</h1><br/>
				        <hr className='w-30 fl  '></hr><br/><br/>
				        <p className="f5 f4-l lh-copy athelas mobile-display-font-size-paragraph ">
				  ...
				  <article className="pv4 bt bb b--black-10 ph3 ph0-l">
				    <div className="flex flex-column flex-row-ns">
				      <div className="w-100 w-80-ns pr3-ns order-2 order-1-ns ">
				        <h1 className="f2 fw5  mt0 lh-title mobile-display-font-size-header">JAY PATEL</h1>
				        <h1 className="f3  mt0 lh-title mobile-display-font-size-sub-header gray">CONSTRUCTION MANAGER</h1><br/>
				        <hr className='w-30 fl  '></hr><br/><br/>
				        <p className="f5 f4-l lh-copy athelas mobile-display-font-size-paragraph">
				  ...
				  <article className="pv4 bt bb b--black-10 ph3 ph0-l">
				    <div className="flex flex-column flex-row-ns">
				      <div className="w-100 w-80-ns pr3-ns order-2 order-1-ns ">
				        <h1 className="f2 fw5  mt0 lh-title mobile-display-font-size-header">BRENDA OMWAMI</h1>
				        <h1 className="f3  mt0 lh-title mobile-display-font-size-sub-header gray ">HSEQ MANAGER</h1><br/>
				        <hr className='w-30 fl  '></hr><br/><br/>
				        <p className="f5 f4-l lh-copy athelas mobile-display-font-size-paragraph ">
				  ...
				  <article className="pv4 bt bb b--black-10 ph3 ph0-l">
				    <div className="flex flex-column flex-row-ns">
				      <div className="w-100 w-80-ns pr3-ns order-2 order-1-ns ">
				        <h1 className="f2 fw5  mt0 lh-title mobile-display-font-size-header">BABATUNDE OMONDI</h1>
				        <h1 className="f3  mt0 lh-title mobile-display-font-size-sub-header gray">NEW BUSINESS MANAGER</h1><br/>
				        <hr className='w-30 fl  '></hr><br/><br/>
				        <p className="f5 f4-l lh-copy athelas mobile-display-font-size-paragraph ">
				  ...
				  <article className="pv4 bt bb b--black-10 ph3 ph0-l">
				    <div className="flex flex-column flex-row-ns">
				      <div className="w-100 w-80-ns pr3-ns order-2 order-1-ns ">
				        <h1 className="f2 fw5  mt0 lh-title mobile-display-font-size-header">ANNALYN MAHALIA</h1>
				        <h1 className="f3  mt0 lh-title mobile-display-font-size-sub-header gray ">FINANCE MANAGER</h1><br/>
				        <hr className='w-30 fl  '></hr><br/><br/>
				        <p className="f5 f4-l lh-copy athelas mobile-display-font-size-paragraph">
