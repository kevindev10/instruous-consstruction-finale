  ...
  return (
   	<div>
			...
			<div className='home-about-link-main'>
				...
				<p className='grow link f3 home-about-link pointer' >
					<Link  to='/about' className='no-underline black'>About</Link>
				</p>
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer'>
					<Link  to='/ourvalues' className='no-underline black'>Our Values</Link>
				</p>
			</div>
			<div>
			...
			<div className=' athelas'>
				<h2 className='mobile-display-font-size-header center '>WHAT WE STAND FOR</h2>
				<p className='i  mv4 fw8 mobile-display-font-size-sub-header f3 gray center'>“We are driven to be better in everything we do.”</p>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>We appreciate you may have seen numerous ‘Our Values’ 
				pages. Yet for us, these aren’t simply words on a page. They’re common 
				...
				<h2 className='mobile-display-font-size-header center '>AUTHENTIC</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>Authentic, honest conversations occur naturally with 
				our clients because we believe the greatest success is found in
				collaboration and accountability. We do what we say we will, which leads
				 to the kind of trust that achieves world-class outcomes.</p><br/>
				<h2 className='mobile-display-font-size-header center '>LEADERSHIP</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>It’s said that true leadership isn’t about wanting to
				 be a leader; it’s about wanting to make a difference. Empowering others to  come together and make an impact is what leadership means to us.</p><br/>
				<h2 className='mobile-display-font-size-header center  '>RELENTLESS</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>Overcoming the many challenges that arise in 
				construction isn’t a matter of luck. It’s about being relentless and
				 knowing deep  down that the most breathtaking results are often born
				 out of the hardest situations</p><br/>
				<h2 className='mobile-display-font-size-header center '>EXCELLENCE</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>We’re yet to work with a client who believes that
				close enough is good enough. Industry best developments require a certain  standard of excellence, and it’s this shared belief that realises the potential of every project.</p><br/>
				<h2 className='mobile-display-font-size-header center '>PASSION</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>Knowledge may be the vehicle, but it’s passion that
				 drives it. When you absolutely love what you do, it’s second nature to go the extra mile, think outside the box and fine-tune processes long after the others may have gone home.</p><br/>
				<h2 className='mobile-display-font-size-header center '>FUN</h2>
				<p className='mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5 '>We love hearing a client tell us that working together was 
				really enjoyable. It’s impossible to deliver a great project without having
