  ...
  return (
   	<div>
			...
			<div className='home-about-link-main'>
				...
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer' >
					<Link  to='/csr' className='no-underline black'>Csr</Link>
				</p>
			</div>

			<div>
				<p className='f2 ml4 mt0 mb3 fw6'>Corporate Social Responsibility</p>
			</div>
			
			<div className='ml4 athelas'>
				<p className='f3 mobile-display-font-size-paragraph f4 mobile-paragraph-padding mh5'>We believe that a community can reach its full 
				potential when we act with generosity and compassion. Through our  
