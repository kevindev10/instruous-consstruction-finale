   	...
   	<div>
			...
			<div className='home-about-link-main'>
				<p className='grow link f3 home-about-link pointer'>
					<NavLink exact link to='/' className='no-underline black'>Home</NavLink>
				</p>
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer' >
					<NavLink exact link to='/about' className='no-underline black'>About</NavLink>
				</p>
			</div>
			<div>
				...
				<iframe width="630" height="370"
					className='youtube'
					src="https://www.youtube.com/embed/dtqYYVZWw3s?controls=0" 
					title="Construction vid"
					frameborder="0"
			...
			<div className=' ml4 mt0 mobile-paragraph-padding-main'>

				<p className='f3 athelas pb0 mb0 mh5 mobile-paragraph-padding'>
					          
					<div className='mobile-display-font-size-sub-header f3 gray '>INSTRUOUS CONSTRUCTION COMPANY</div> <br/><br/><br/>
					<div className='mobile-display-font-size-paragraph f4 '>Instruous Construction is one of the worlds's largest vertically integrated building
					materials and construction companies.
					Since 1898, we have helped customers complete more than 25,000 projects in 160 countries 
					on all seven continents that have created jobs, grown economies, improved the resiliency
					of the world's infrastructure, increased access to energy, resources, and vital services,
					and made the world a safer, cleaner place. 

                    Differentiated by the quality of our people and our relentless drive to deliver the most successful
                     outcomes, we align our capabilitis to our customers objectives to create a lasting positive impact.<br/><br/><br/>

					Instrous Construction's  service offering for our clients is flexible and comprehensive.
					 We have comprehensive experience with every aspect of construction and we look forward to
					  working with our clients from design to occupancy and warranty.</div><br/><br/><br/><br/>
