  ...
  return (
   	<div className=''>
			...
			<div className='home-about-link-main'>
				...
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer'>
					<Link to='/services' className='no-underline black'>Services</Link>
				</p>
			</div>
			<div>
				<p className='f1 ml4 mt0 mb3 fw6'> SERVICES </p>
				<p className=' ml4 mt0 mb3 fw6 mobile-display-font-size-sub-header f3 gray'>INSTRUOUS COMMERCIAL CONSTRUCTION SERVICES</p>
				<p className=' ml4 mt0 mb3  athelas mobile-display-font-size-paragraph f4'>We make a promise, to not only finish your project on time and on budget, but to realise its full potential.</p>
			</div>
			<div>
