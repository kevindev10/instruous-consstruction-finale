  ...
  return (
   	<div>
			...
			<div className='home-about-link-main'>
				...
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer'>
					<Link  to='/hseq' className='no-underline black'>Hseq</Link>
				</p>
			</div>
			<div>
			...
			<div className='ml4 athelas'>
				<h2 className='mobile-display-font-size-sub-header f3 gray '>HEALTH & SAFETY</h2>
				<p className=' mobile-display-font-size-paragraph f4 mh1'>It is impossible to find two words more important to us than Health and Safety. 
				We have an immense responsibility to our staff  and subcontractors in making sure
				 they go home safely every single day. There is no objective or goal more important 
				 an the safety of our people.</p><br/>
				<h2 className='mobile-display-font-size-sub-header f3 gray  '>QUALITY</h2>
				<p className='mobile-display-font-size-paragraph f4 mh1'>Our INSTRUOUS Integrated Management System, which not only encompasses HSEQ, but all
				 aspects of our business operations, ensures we implement industry-leading practices. 
				 Our large-scale buying power and nimble, accountable team gives us tight control
				  over quality in our products and our processes.</p><br/>
				<h2 className='mobile-display-font-size-sub-header f3 gray '>ENVIRONMENT & SUSTAINABILITY</h2>
				<p className='mobile-display-font-size-paragraph f4  mh1'>At INSTRUOUS, we believe that complying with applicable environmental legislation is just the
				 beginning. We have a responsibility to the  community to proactively identify environmental
				  risks and prevent pollution where possible. We have an ongoing commitment to  divert more
				   than 90% of waste generated through our activities from landfill.</p><br/>
			</div>

			<div className='f3 ml4 athelas'>
				<p className='fw6 pa2 mobile-display-font-size-header f2 '>Our Health, Safety, Environment, & Quality Policies</p>
				<ul>
					<li >
						<a href = {QualityPolicy} target = "_blank" rel="noopener noreferrer" className='no-underline link black dim  gray'>Quality Policy</a>
					</li>
					<li>
						<a href = {OccupationalHealthandSafetyPolicy} target = "_blank" rel="noopener noreferrer" className='no-underline link black dim gray'>Occupational Health and Safety Policy</a>
						
					</li>
					<li>
						<a href = {EnvironmentalPolicy1} target = "_blank" rel="noopener noreferrer" className='no-underline link black dim gray'>Environmental Policy</a>
						
					</li>
					<li>
						<a href = {FitnessforWorkPolicy1} target = "_blank" rel="noopener noreferrer" className='no-underline link black dim gray'>Fitness for Work Policy</a>
