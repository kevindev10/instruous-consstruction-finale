  ...
  return (
   <div >
			<div>
				...
				<img style={{'width':'100%','height':'800px'}}className ='banner' src ={banner} alt='Completed project one'/>
			</div>
			<div className='home-about-link-main when-on-mobile-routing-main'>
				...
				<p className='grow link f3 home-about-link pointer when-on-mobile-routing' >
					<Link  to ='/contact' className='black no-underline'>Contact</Link>
				</p>
			...
			<div className ='when-on-mobile ' >
				...
				<header className="fn fl-ns w-50-ns pr4-ns">
				    ...
				    <h2 className="f3 mid-gray lh-title mt0  fw9  ">
				      Telephone
				    </h2>
				    <time className="f4   gray   ">(1000) 1234 5678</time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4  mr5 linez'/>

				    <h2 className="f3 mid-gray lh-title mt0  fw9  ">
				      Email
				    </h2>
				    <time className="f4   gray  " style={{"word-wrap": "break-word"}}>admin@instruousconstruction.com </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4  mr5 linez'/>
				    <h2 className="f3 mid-gray lh-title mt0  fw9 ">
				      Address
				    </h2>
				    <time className="f4   gray    "> There and Then street,Crossback Park ba 123567 </time>
				    <div style={{'border-top':'1px solid #B8B8B8 '}}  className='mv4  mr5 linez'/>
				  ...
				  <div className="fn fl-ns w-50-ns ">
				  	<p className='f3 fw5 mt6'>WE BELIEVE THAT EVERY PROJECT, AND EVERY PERSON, HAS INCREDIBLE POTENTIAL.</p>
				    <p className="f4 lh-copy measure athelas mobile-display-font-size-paragraph  mobile-paragraph-padding ">
				      This creates a culture of possibilities – a wonderment of what can happen when talented people are nurtured,
				       accountability replaces ego and every project is optimised upon a foundation of unwavering trust. With a 
				       ‘hands on’ approach and the secure backing of the XYX Group, we believe we’re the people to find the potential
				    ...
				    <div className=''>
					    <form action="https://formsubmit.co/Kevozzz@yahoo.com" method="POST">
					    	...
					    	<div class="col">
						    	 <input type="text" name="name" required placeholder='Full Name' className='ml0 form-control ma3 pa3 w-80 f3 br1 shadow-5'/>
						    </div>
						    <div className="col">	 
						     <input type="email" name="email" required placeholder='Email Address' className='ml0 form-control ma3 pa3 w-80 f3 br1 shadow-5'/>
							</div>
							<div className="col">
						     <input type="text" name="phone" required placeholder='Phone Number' className='ml0 form-control ma3 pa3 w-80 f3 br1 shadow-5'/>
						    </div>
						    <div className="col">
						     <input type="text" name="subject" required placeholder='Subject' className='ml0 form-control ma3 pa3 w-80 f3 br1 shadow-5'/>
						    </div> 
